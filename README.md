...
> Snapshot note
>
> This repository is a reverted snapshot of [VoltAgent/awesome-design-md](https://github.com/VoltAgent/awesome-design-md), published for easier sharing of the pre-`getdesign.md` version. This snapshot is based on upstream commit `ef729b2` and keeps the original MIT license. All trademarks, logos, and visual identities referenced here remain the property of their respective owners.
